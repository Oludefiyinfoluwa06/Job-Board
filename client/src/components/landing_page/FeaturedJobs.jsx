        ...
        <div className='my-[30px]'>
            ...
            <div className='flex items-center justify-center flex-wrap gap-5 mt-4'>
                {featuredJobs.map(item => (
                    <div key={item.id} id='fj-box' className='relative md:w-[calc(100%/3-20px)] sm:w-[calc(100%/2-20px)] w-full h-[300px] p-4 border border-slate-300 rounded-md'>
                        ...
                        <div className='flex items-center justify-start gap-3 mt-3'>
                            {item.skills.map((skill, index) => (
                                <p key={index} className='px-3 py-1 bg-slate-100 text-slate-700 rounded-md text-[12px]'>{skill}</p>
                            ))}
                        </div>
